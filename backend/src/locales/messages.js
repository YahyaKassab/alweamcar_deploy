const messages = {
  ...
  make_model_required: {
    en: 'Either provide both make name and model',
    ar: 'برجاء اضافة نوع وموديل السيارة',
  },
  ...
  provide_old_new_password: {
    en: 'Please provide old and new passwords',
    ar: 'يرجى تقديم كلمة المرور القديمة والجديدة',
  },
  invalid_old_password: { en: 'Invalid old password', ar: 'كلمة المرور القديمة غير صحيحة' },
